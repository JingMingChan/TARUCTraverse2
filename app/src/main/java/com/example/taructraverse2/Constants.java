...
public class Constants {
    ...
    private static final String ROOT_URL="https://backup-taruc-traverse.000webhostapp.com/taruc_traverse/v1/";

    public static final String URL_REGISTER = ROOT_URL+"register.php";
    public static final String URL_LOGIN = ROOT_URL+"userLogin.php";
    public static final String URL_RETRIEVE_USER = ROOT_URL+"retrieveUser.php";
    public static final String URL_UPDATE_USER = ROOT_URL+"updateUser.php";
    public static final String URL_LOCATION_SEARCH = ROOT_URL+"locationSearch.php";
    public static final String URL_GET_BLOCKID = ROOT_URL+"getBlockID.php";
